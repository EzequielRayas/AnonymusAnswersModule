...
@php
    ...
    $maxWidth = [
        ...
        'xl' => 'sm:max-w-xl',
        '2xl' => 'sm:max-w-2xl',
        '3xl' => 'sm:max-w-3xl', // Añadido
        '4xl' => 'sm:max-w-4xl', // Añadido (Este es el que causó el error)
        '5xl' => 'sm:max-w-5xl', // Añadido
        '6xl' => 'sm:max-w-6xl', // Añadido
        '7xl' => 'sm:max-w-7xl', // Añadido
    ][$maxWidth ?? '2xl']; // Si no se especifica, usa 2xl como fallback
@endphp
